...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../opt/Xilinx/2026.1/data/rsb/busdef" +incdir+"../../../../DDS.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../opt/Xilinx/2026.1/data/rsb/busdef" +incdir+"../../../../DDS.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jerry/DDS/DDS.cache/compile_simlib/xcelium"
  fi
