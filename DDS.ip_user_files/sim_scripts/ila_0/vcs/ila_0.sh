...
#
# Script generated by Vivado on Tue Aug 25 22:37:17 AWST 2026
...
# script info
echo -e "ila_0.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../opt/Xilinx/2026.1/data/rsb/busdef" +incdir+"../../../../DDS.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../opt/Xilinx/2026.1/data/rsb/busdef" +incdir+"../../../../DDS.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jerry/DDS/DDS.cache/compile_simlib/vcs"
  fi
